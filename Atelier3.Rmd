...
Consommation chez les hommes et chez les femmes 
...
```{r}
pie(table(viande.h),main = "chez l'homme")
```
```{r}
pie(table(viande.f),main = "chez la femme")
```
...
```{r}
pie(table(poisson.h),main = "chez l'homme")
```


```{r}
pie(table(poisson.f),main = "chez la femme")
```
...
```{r}
pie(table(chocol.h),main = "chez l'homme")
```
...
Calculer l'IMC à la population
